...
Public Class rptCuadreCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionServicios.rptCuadreCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCuadreCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCuadreCaja = New rptCuadreCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
