...
Public Class rptVentasPorProductos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptVentasPorProductos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionServicios.rptVentasPorProductos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasPorProductos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasPorProductos = New rptVentasPorProductos()
        rpt.Site = Me.Site
        Return rpt
    End Function
