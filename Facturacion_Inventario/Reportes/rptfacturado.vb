...
Public Class rptfacturado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionServicios.rptfacturado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptfacturado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptfacturado = New rptfacturado()
        rpt.Site = Me.Site
        Return rpt
    End Function
