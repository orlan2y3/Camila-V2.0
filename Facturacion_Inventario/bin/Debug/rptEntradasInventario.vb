...
Public Class rptEntradasInventario
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEntradasInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionServicios.rptEntradasInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEntradasInventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEntradasInventario = New rptEntradasInventario()
        rpt.Site = Me.Site
        Return rpt
    End Function
