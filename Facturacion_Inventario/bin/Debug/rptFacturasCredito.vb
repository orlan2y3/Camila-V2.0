...
Public Class rptFacturasCredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FacturacionServicios.rptFacturasCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturasCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturasCredito = New rptFacturasCredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
